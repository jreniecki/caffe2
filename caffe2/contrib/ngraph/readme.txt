...
New type of network is created and register - named "ngraph"
This is quite non-intrusive - the rest of the caffe2 is not touched by this change.
...
Then simply we define NgraphNet::Run() method to output the graph to ngraph instead of actually executing the computations.
...
In this approach there is not much difference between high-graph and low-graph approach.
